# Generated by Django 3.1.4 on 2021-01-04 04:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DjangoHeroes.category')),
                ('origin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DjangoHeroes.origin')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DjangoHeroes.category')),
                ('father', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='DjangoHeroes.hero')),
                ('mother', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='DjangoHeroes.hero')),
                ('origin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='DjangoHeroes.origin')),
                ('spouse', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='DjangoHeroes.hero')),
            ],
            options={
